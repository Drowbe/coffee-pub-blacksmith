...
**Zone reference:** See [primer-applicationv2-zones.webp](https://raw.githubusercontent.com/Drowbe/coffee-pub-blacksmith/master/documentation/assets/primer-applicationv2-zones.webp) for the layout. See [primer-applicationv2-samples.png](https://raw.githubusercontent.com/Drowbe/coffee-pub-blacksmith/master/documentation/assets/primer-applicationv2-samples.png) for real windows and which zones they use.
...
4. Add CSS for `.example-window-root`, `.example-window-option-bar`, `.example-window-header`, `.example-window-body`, `.example-window-buttons` (or rename classes). See `guidance-applicationv2.md` §6.3 for layout patterns.
5. Open the window from your API or a button, e.g. `new YourWindow().render(true)`.

## Reference

The zone contract is documented in Blacksmith's Window API documentation, which is authoritative.
