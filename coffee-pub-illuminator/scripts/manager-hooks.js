...
export class HookManager {
    ...
    static showHooks() {
        const stats = this.getStats();
        console.log(`COFFEE PUB • ${MODULE.NAME} | Total Hooks: ${stats.totalHooks}`);
    ...
    static initialize() {
        ...
        postConsoleAndNotification(
            ...
            'Initialized with console commands: illuminatorHooks(), illuminatorHookDetails(), illuminatorHookStats()',
            true,
            false
        );
        ...
        if (typeof window !== 'undefined') {
            ...
            window.illuminatorHooks = () => HookManager.showHooks();
            window.illuminatorHookDetails = () => HookManager.showHookDetails();
            window.illuminatorHookStats = () => HookManager.getStats();
