...
- **Skill Check Card Theme Migration**: Migrated skill check chat cards to use the `blacksmith-card` theme system for consistent styling and v13 compatibility. Cards now leverage the standard `.section-header` styling from the theme instead of custom header styles.
