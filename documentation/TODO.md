...
- **Issue**: no at-a-glance visual of token health on the canvas. Idea: a blood-splatter overlay per token whose splatter tier follows % remaining HP (thresholds like bloodied/critical), optionally with a brief animation on damage taken.
