...
| `blacksmith.effects` | Read-only Active Effect filtering, display normalization, condition labels, and classifier registration. See [api-effects](../api/api-effects.md). |
